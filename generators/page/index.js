	...
	actions: function (data) {
		...
		if (data.IS_SUB_PACKAGE.toUpperCase() === 'Y') {
			actions = actions.concat([
				{
					...
					path: '../src/{{camelCase FILE_NAME}}/index.tsx', // 添加的文件的路径
					templateFile: './page/page.hbs', // 模板文件的路径
				},
				{
					type: 'add', // 操作类型，这里是添加文件
					path: '../src/{{camelCase FILE_NAME}}/index.scss', // 添加的文件的路径
					templateFile: './page/scss.hbs', // 模板文件的路径
				},
				{
					type: 'add', // 操作类型，这里是添加文件
					path: '../src/{{camelCase FILE_NAME}}/index.config.ts', // 添加的文件的路径
			...
			actions = actions.concat([
				{
					type: 'add', // 操作类型，这里是添加文件
					path: '../src/pages/{{camelCase FILE_NAME}}/index.tsx', // 添加的文件的路径
					templateFile: './page/page.hbs', // 模板文件的路径
				},
				{
					type: 'add', // 操作类型，这里是添加文件
					path: '../src/pages/{{camelCase FILE_NAME}}/index.scss', // 添加的文件的路径
					templateFile: './page/scss.hbs', // 模板文件的路径
				},
				{
					type: 'add', // 操作类型，这里是添加文件
					path: '../src/pages/{{camelCase FILE_NAME}}/index.config.ts', // 添加的文件的路径
					templateFile: './page/config.hbs', // 模板文件的路径
				},
			])
		}
