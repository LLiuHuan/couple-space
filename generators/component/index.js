	...
	actions: function (data) {
		...
		if (data.IS_SUB_PACKAGE.toUpperCase() === 'Y') {
			actions = actions.concat([
				{
					...
					path: '../src/{{pascalCase FILE_NAME}}/Components/index.tsx', // 添加的文件的路径
					templateFile: './component/component.hbs', // 模板文件的路径
				},
				{
					type: 'add', // 操作类型，这里是添加文件
					path: '../src/{{pascalCase FILE_NAME}}/Components/index.scss', // 添加的文件的路径
			...
			actions = actions.concat([
				{
					type: 'add', // 操作类型，这里是添加文件
					path: '../src/components/{{pascalCase FILE_NAME}}/index.tsx', // 添加的文件的路径
					templateFile: './component/component.hbs', // 模板文件的路径
				},
				{
					type: 'add', // 操作类型，这里是添加文件
					path: '../src/components/{{pascalCase FILE_NAME}}/index.scss', // 添加的文件的路径
					templateFile: './component/scss.hbs', // 模板文件的路径
				},
			])
		}
